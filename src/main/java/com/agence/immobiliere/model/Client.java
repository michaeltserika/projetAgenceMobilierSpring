...
public class Client {
    ...
    public Client() {}
    public Client(Integer utilisateurId, String nom, String prenom, LocalDate dateNaissance, String villeNaissance, String cin, String cinDelivrer, String phone, String email, String imagePath) {
    ...
    public String getCinDelivrer() { return cinDelivrer; }
    public void setCinDelivrer(String cinDelivrer) { this.cinDelivrer = cinDelivrer; }
